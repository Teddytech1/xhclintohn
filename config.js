...
module.exports = {
    ...
    BOT: process.env.BOT_NAME || 'TEDDY_XMD',
    URL: process.env.BOT_MENU_LINKS || 'https://files.catbox.moe/rfronl.jpg',
    BWM_XMD: hybridConfig.buildContentLayer(),
    GURL: 'https://whatsapp.com/channel/0029Vb4WwGo4CrffIZhlnv1Y',
